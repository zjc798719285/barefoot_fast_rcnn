...
>>>>>>> parent of e4f2bf3... The train streamline has been worked,but test streamline has some bugs,I will try later
...
=======
    ...
    roi_loss = loss_box_regressor(gt=GroundTruthRoi, dr=box, mode=params.box_loss)
>>>>>>> parent of e4f2bf3... The train streamline has been worked,but test streamline has some bugs,I will try later
