...
class SSDModel(object):
    ...
    def __call__(self, x):
        ...
        conv1 = Conv2D(32, (5, 5), strides=(1, 1), padding="same", kernel_initializer=self.init,
                       kernel_regularizer=l2(self.l2_reg), name='conv1')(x)
        conv1 = Activation(activation='relu')(conv1)
        pool1 = MaxPooling2D(pool_size=(2, 2), name='pool1')(conv1)
        conv2 = Conv2D(64, (3, 3), strides=(1, 1), padding="same", kernel_initializer=self.init,
                       kernel_regularizer=l2(self.l2_reg), name='conv2')(pool1)
        conv2 = Activation(activation='relu')(conv2)
        conv3 = Conv2D(128, (3, 3), strides=(1, 1), padding="same", kernel_initializer=self.init,
                       kernel_regularizer=l2(self.l2_reg), name='conv3')(conv2)
        conv3 = Activation(activation='relu')(conv3)
        pool3 = MaxPooling2D(pool_size=(2, 2), name='pool3')(conv3)
        conv4 = Conv2D(256, (3, 3), strides=(1, 1), padding="same", kernel_initializer=self.init,
                       kernel_regularizer=l2(self.l2_reg), name='conv4')(pool3)
        conv4 = Activation(activation='relu')(conv4)
        conv5 = Conv2D(256, (3, 3), strides=(1, 1), padding="same", kernel_initializer=self.init,
                       kernel_regularizer=l2(self.l2_reg), name='conv5')(conv4)
        conv5 = Activation(activation='relu')(conv5)
        conv6 = Conv2D(256, (3, 3), strides=(1, 1), padding="same", kernel_initializer=self.init,
                       kernel_regularizer=l2(self.l2_reg), name='conv6')(conv5)
        conv6 = Activation(activation='relu')(conv6)
        pool6 = MaxPooling2D(pool_size=(2, 2), name='pool6')(conv6)
        conv7 = Conv2D(32, (3, 3), strides=(1, 1), padding="same", kernel_initializer=self.init,
        ...
        conv8 = Conv2D(32, (3, 3), strides=(1, 1), padding="same", kernel_initializer=self.init,
        ...
        anchor7 = AnchorBoxes(img_height=866, img_width=389,
                              aspect_ratios=self.aspect_ratios,
                              scales=self.scales[0])(boxes_offset7)
        anchor8 = AnchorBoxes(img_height=866, img_width=389,
                              aspect_ratios=self.aspect_ratios,
                              scales=self.scales[1])(boxes_offset8)
