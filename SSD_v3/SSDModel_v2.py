...
class SSDModel(object):
    def __init__(self,
        ...
        self.basenet_trainable = False
        self.classes_trainable = False
        self.offset_trainable = True

    def __call__(self, x):
        net1 = Conv2D(64, (7, 7), padding='same', strides=[2, 2],
                  kernel_initializer=self.init, activation='relu', trainable=False)(x)
        ...
        classes3 = Conv2D(n_boxes * self.n_classes, (1, 1), strides=(1, 1), padding="same",
                          ...
                          name='classes3', activation='sigmoid', trainable=self.classes_trainable)(net3)
        classes3 = Conv2D(n_boxes * self.n_classes, (1, 1), strides=(1, 1), padding="same",
                          kernel_initializer='glorot_uniform', kernel_regularizer=l2(self.l2_reg),
                          name='classes3', activation='sigmoid', trainable=self.classes_trainable)(classes3)
        # classes3 = tf.nn.softmax(classes3)
        classes2 = Conv2D(n_boxes * self.n_classes, (1, 1), strides=(1, 1), padding="same",
                          kernel_initializer='glorot_uniform', kernel_regularizer=l2(self.l2_reg),
                          name='classes2', activation='sigmoid', trainable=self.classes_trainable)(net2)
        classes2 = Conv2D(n_boxes * self.n_classes, (1, 1), strides=(1, 1), padding="same",
                          kernel_initializer='glorot_uniform', kernel_regularizer=l2(self.l2_reg),
                          name='classes2', activation='sigmoid', trainable=self.classes_trainable)(classes2)
        ...
        boxes_offset3 = Conv2D(n_boxes * 4, (1, 1), strides=(1, 1), padding="same",
                        kernel_initializer='zeros', activation='tanh', kernel_regularizer=l2(self.l2_reg),
                        name='boxes3', trainable=self.offset_trainable)(boxes_offset3)
        # boxes_offset3 = Conv2D(n_boxes * 4, (1, 1), strides=(1, 1), padding="same",
        ...
        boxes_offset2 = Conv2D(n_boxes * 4, (1, 1), strides=(1, 1), padding="same",
                        kernel_initializer='zeros', kernel_regularizer=l2(self.l2_reg),
                        name='boxes2', activation='tanh', trainable=self.offset_trainable)(boxes_offset2)
        ...
        anchor3_reshaped = Reshape((-1, 4), name='anchor3_reshaped')(anchor3)
        anchor2_reshaped = Reshape((-1, 4), name='anchor2_reshaped')(anchor4)
