...
class SSDModel(object):
    ...
    def __call__(self, x):
        ...
        conv9 = Conv2D(32, (3, 3), strides=(1, 1), padding="same", kernel_initializer='he_normal',
                       kernel_regularizer=l2(self.l2_reg), name='conv9')(pool8)
        ...
        # classes9 = Conv2D(n_boxes * self.n_classes, self.detect_kernel, strides=(1, 1), padding="same",
        #                   kernel_initializer='he_normal', kernel_regularizer=l2(self.l2_reg),
        #                   name='classes7', activation='sigmoid')(conv9)
        ...
        # boxes_offset9 = Conv2D(n_boxes * 4, self.detect_kernel, strides=(1, 1), padding="same",
        #                        kernel_initializer='he_normal', kernel_regularizer=l2(self.l2_reg),
        #                        name='boxes7', activation='sigmoid')(conv9)
        ...
        anchor7 = AnchorBoxes(img_height=866, img_width=389,
                              ...
                              scales=self.scales,
                              detect_kernel=self.detect_kernel)(boxes_offset7)
        anchor8 = AnchorBoxes(img_height=866, img_width=389,
                              aspect_ratios=self.aspect_ratios,
                              scales=self.scales,
                              detect_kernel=self.detect_kernel)(boxes_offset8)
        # anchor9 = AnchorBoxes(img_height=866, img_width=389,
        #                       aspect_ratios=self.aspect_ratios,
        #                       scales=self.scales,
        #                       detect_kernel=self.detect_kernel)(boxes_offset9)
        ...
        # classes9_reshaped = Reshape((-1, self.n_classes), name='classes7_reshape')(classes9)
        ...
        # boxes_offset9_reshaped = Reshape((-1, 4), name='boxes7_reshape')(boxes_offset9)
        ...
        # anchor9_reshaped = Reshape((-1, 4), name='anchor4_reshaped')(anchor9)
